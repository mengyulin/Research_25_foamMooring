...
- 初始吃水深度 (d): 0.0786 m
- 浮體質量: 3.16 kg
- 質量中心 \((x, y, z)\): (0, 0, -0.0126) m
- 浮體慣性矩: \((I_{xx}, I_{yy}, I_{zz})\): \((0.015, 0.015, 0.021)~\mathrm{kg\, m^2}\)
- 靜止水深\(h\): 0.5 m

** 繫泊條件

- 繫纜單位長度質量: 0.607 g/cm = 0.0607 kg/m
- 繫纜直徑: 0.003656 m
- 繫纜長度: 1.455 m
- 繫纜軸向剛度 (axial stiffness) 29 N
- 繫纜導纜器 (fairlead, 與浮體連接處): \((x, y, z) = (\pm 0.1, \pm 0.1, -0.0736)\) m
- 繫纜錨定處 (ahcnor, 與底床連接處): \((x, y, z) = (\pm 1.385, \pm 0.423, -0.5)\) m
...
- 短週期波（T < 1.4 s）：波浪變化快，主要影響 *surge* 運動；
- 長週期波（T > 1.6 s）：波浪能量集中，容易引發浮體共振。
...
1. 在 ParaView 中開啟纜線的 VTK 檔。以 Overset 案例為例，VTK 檔位於
   #+begin_src bash
   background/Mooring/VTK/mdv2_pt.pdv
   #+end_src
