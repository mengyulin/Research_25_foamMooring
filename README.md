...
1.  [研究目的](#org9e280b6)
2.  [基準模擬條件概述](#org8091ccf)
    1.  [模擬區域設定](#orge25577e)
    2.  [基礎浮體條件](#org843643e)
    3.  [基礎繫泊條件](#org0984770)
    4.  [Chen and Hall (2022) 之波浪條件](#orgd034cef)
3.  [計算條件設定](#orge8151f6)
    1.  [浮體幾何與波浪參數計算程式](#org734e5f4)
    2.  [第一組 (基準案例)](#org2baa6ab)
    3.  [第二組 (較大波高)](#orgee33ed5)
    4.  [第三組 (寬浮體)](#org5361577)
4.  [波浪參數意義與物理說明](#org9d07676)
    1.  [波浪週期 T](#orgf9b2593)
    2.  [波高 H](#org7fb8ec3)
    3.  [波長 L](#org9318eab)
    4.  [波陡度 H/L](#orgca647f1)
    5.  [水深 h](#org5e6571f)
5.  [RAO 的意義與計算](#orgf69aff5)
    1.  [RAO 的基本定義](#org89e70fd)
    2.  [三個自由度的 RAO 定義](#org297f218)
    3.  [實際計算步驟](#org7b07a49)
        1.  [輸入波參數](#orge16261a)
        2.  [FFT 分析](#org5b7a9ce)
        3.  [最小平方法擬合](#orge48f4ec)
        4.  [計算 RAO](#orgb35ccd8)
    4.  [結果解讀](#org9020f1b)
6.  [實驗步驟建議](#org83600ae)
7.  [分析與討論方向](#orgbf4041e)
8.  [學習重點](#orgaefab9f)
9.  [延伸方向](#org3bf7686)
10. [Overset 計算執行](#org41f2d01)
    1.  [計算指令](#org7cd5d0a)
    2.  [平行計算設定](#orgb89aecb)
    3.  [計算分割數](#org52d8d4b)
11. [ParaView 繪圖與前後處理](#org254f585)
    1.  [ParaView 繪圖](#org61f56cd)
        1.  [直接開啟 `state` 檔](#orga06c726)
        2.  [波浪流場與物體繪製流程](#orgd05dd53)
        3.  [繪製繫纜線](#org021dc4e)
    2.  [ParaView 動畫輸出](#org4404a89)
        1.  [安裝 ffmpeg](#orgd1d51e4)
        2.  [OpenFOAM 輸出動畫影格](#org7ac4756)
        3.  [使用 ffmpeg 合成影片](#orgeb4c53d)
        4.  [可選：影片壓縮與縮放](#orgdfff8c1)
        5.  [提示](#org6b46cd8)
    3.  [前、後處理之 Python 程式碼](#orgba365fd)
    4.  [附註： Jupyter Notebook 安裝方法](#orgfbf5f55)
12. [成果報告](#org9c9cd18)
    1.  [內容架構](#org426bb46)
    2.  [成果呈現參考資訊](#orgfb02bd0)
        1.  [基本方程式與數值方法](#orge0a0fc3)
        2.  [模式設置與驗證](#org25fe4e4)
        3.  [成果分析](#orge7b4755)
    3.  [成果報告與海報範例](#orge354ab4)
13. [風力模組與計算](#org633a466)
14. [參考文獻](#orgbc35ddd)
...
-   基本方程式: 參考 Chen and Hall (<a href="#citeproc_bib_item_2">2022</a>) 之 Sec. 2 Methodology。
-   數值模式簡介: 包含了
    
    -   OpenFOAM 簡介
    -   繫纜系統工具庫 foamMooring 簡介
    
    均可參考 Chen and Hall (<a href="#citeproc_bib_item_2">2022</a>) 及 Chen, Medina, and Cercos-Pita (<a href="#citeproc_bib_item_1">2024</a>)。
...
-   模式設置與驗證，均可參考 Chen and Hall (<a href="#citeproc_bib_item_2">2022</a>) 之 Sec. 3.2 Numerical model setup，但要注意本研究是二維模擬，而論文中為三維。
...
-   浮體 3DoF 位移、RAO 成果與波浪流場展示: 參考 Islam et al. (<a href="#citeproc_bib_item_3">2019</a>)。
-   纜繩張力分析: 參考 Chen and Hall (<a href="#citeproc_bib_item_2">2022</a>) 及 Chen, Medina, and Cercos-Pita (<a href="#citeproc_bib_item_1">2024</a>)。
...
-   期末書面報告與海報 (poster) 的製作指引，見資料夾 [report tutorial](./docs/report_tutorial)。
-   書面報告可 Word 格式，可以根據碩士論文的樣式來修改 (可刪去誌謝、英文摘要等部分): [碩士論文樣式檔](./docs/report_tutorial/cycu_thesis_example.doc)。
-   過去學生之成果報告 (Word 檔) 與海報 (PPT 檔) 範例，見資料夾 [example](./docs/example)。
-   課程的 Notion 頁面也有許多參考資訊：[Notion page](https://pond-bass-4f5.notion.site/2025-1a474decdb7d806cbc7ac3cbafaa0b5f?source=copy_link)。
...
論文檔案見資料夾 [references](./references)。

<div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a>Chen, Haifei, Tanausú Almeida Medina, and Jose Luis Cercos-Pita. 2024. “Cfd Simulation of Multiple Moored Floating Structures Using Openfoam: An Open-Access Mooring Restraints Library.” <i>Ocean Engineering</i> 303: 117697. <a href="https://doi.org/10.1016/j.oceaneng.2024.117697">https://doi.org/10.1016/j.oceaneng.2024.117697</a>.</div>
  <div class="csl-entry"><a id="citeproc_bib_item_2"></a>Chen, Haifei, and Matthew Hall. 2022. “Cfd Simulation of Floating Body Motion with Mooring Dynamics: Coupling Moordyn with Openfoam.” <i>Applied Ocean Research</i> 124: 103210. <a href="https://doi.org/10.1016/j.apor.2022.103210">https://doi.org/10.1016/j.apor.2022.103210</a>.</div>
  <div class="csl-entry"><a id="citeproc_bib_item_3"></a>Islam, H., S.C. Mohapatra, J. Gadelho, and C. Guedes Soares. 2019. “Openfoam Analysis of the Wave Radiation by a Box-Type Floating Structure.” <i>Ocean Engineering</i> 193: 106532. <a href="https://doi.org/10.1016/j.oceaneng.2019.106532">https://doi.org/10.1016/j.oceaneng.2019.106532</a>.</div>
</div>
